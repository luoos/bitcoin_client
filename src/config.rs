pub static DIFFICULTY: i32 = 14; // number of leading zero
...
pub static TRANSACTION_GENERATE_INTERVAL: u64 = 20000; // time interval(ms) to add a new-created transaction to mempool
